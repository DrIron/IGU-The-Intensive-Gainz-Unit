...
export const ROUTE_REGISTRY: RouteConfig[] = [
  ...
  { id: "admin-diagnostics", path: "/admin/diagnostics/site-map", label: "Diagnostics", layout: "AdminLayout", requiredRoles: ["admin"], navGroup: "admin", showInNav: true, icon: Stethoscope, navOrder: 15 },
