...
export const ROUTE_REGISTRY: RouteConfig[] = [
  ...
  { id: "coach-public", path: "/coaches/:slug", label: "Coach Profile", layout: "Public", requiredRoles: ["public"], navGroup: null, showInNav: false },
  ...
  { id: "coach-testimonials", path: "/coach/testimonials", label: "Testimonials", layout: "CoachLayout", requiredRoles: ["coach"], navGroup: "coach", showInNav: true, icon: MessageSquare, navOrder: 6.7, description: "Choose which client reviews show on your public profile" },
  ...
  { id: "coach-hub", path: "/coach/hub", label: "Coach Hub", layout: "CoachLayout", requiredRoles: ["coach"], navGroup: "coach", showInNav: true, icon: Library, navOrder: 7.5, description: "Coach-only training, library, and resources" },
  ...
  { id: "learn", path: "/learn", label: "Learn", layout: "ClientLayout", requiredRoles: ["authenticated"], navGroup: "client", showInNav: true, icon: GraduationCap, navOrder: 5, description: "Unified Exercise Library + Videos + Pathways" },
  // Redirect-only: both fold into /learn (see App.tsx). Kept for old bookmarks.
  { id: "workout-library", path: "/workout-library", label: "Exercise Library", layout: "ClientLayout", requiredRoles: ["authenticated"], navGroup: "client", showInNav: false, icon: Dumbbell, navOrder: 5 },
  ...
  { id: "educational-videos", path: "/educational-videos", label: "Educational Videos", layout: "ClientLayout", requiredRoles: ["authenticated"], navGroup: "client", showInNav: false, icon: Video, navOrder: 6 },
