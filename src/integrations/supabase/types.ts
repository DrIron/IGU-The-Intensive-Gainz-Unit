  ...
  public: {
    Tables: {
      ...
      addon_payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "addon_payments_refund_of_fkey"
            columns: ["refund_of"]
            isOneToOne: false
            referencedRelation: "addon_payments"
      ...
      addon_purchases: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "addon_purchases_payment_id_fkey"
            columns: ["payment_id"]
            isOneToOne: true
            referencedRelation: "addon_payments"
            referencedColumns: ["id"]
      ...
      addon_services: {
        ...
        Relationships: [
          {
            foreignKeyName: "addon_services_required_subrole_fk"
            columns: ["required_subrole"]
            isOneToOne: false
      ...
      addon_session_logs: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["addon_purchase_id"]
            isOneToOne: false
            referencedRelation: "addon_purchases_with_remaining"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      food_log_entries: {
        Row: {
          ...
          unit: Database["public"]["Enums"]["food_log_unit"]
          updated_at: string
        }
        Insert: {
          carb_g?: number
      ...
      food_portions: {
        Row: {
          ...
          sort_order: number
          unit_kind: Database["public"]["Enums"]["food_unit_kind"]
        }
        Insert: {
          food_id: string
          gram_weight: number
      ...
      foods: {
        Row: {
          approval_status: Database["public"]["Enums"]["food_approval_status"]
          approved_at: string | null
          approved_by: string | null
          brand: string | null
      ...
      nutrients: {
        Row: {
          ...
          fdc_nutrient_number: string | null
          id: string
          key: string
          name: string
          unit: string
      ...
      nutrition_phase_content_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "nutrition_phase_content_links_nutrition_phase_id_fkey"
            columns: ["nutrition_phase_id"]
            isOneToOne: false
            referencedRelation: "nutrition_phases"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "nutrition_phase_content_links_playlist_id_fkey"
            columns: ["playlist_id"]
            isOneToOne: false
            referencedRelation: "video_playlists"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "nutrition_phase_content_links_video_id_fkey"
            columns: ["video_id"]
            isOneToOne: false
            referencedRelation: "educational_videos"
            referencedColumns: ["id"]
      ...
      program_template_content_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "program_template_content_links_playlist_id_fkey"
            columns: ["playlist_id"]
            isOneToOne: false
            referencedRelation: "video_playlists"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "program_template_content_links_program_template_id_fkey"
            columns: ["program_template_id"]
            isOneToOne: false
            referencedRelation: "program_templates"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "program_template_content_links_video_id_fkey"
            columns: ["video_id"]
            isOneToOne: false
            referencedRelation: "educational_videos"
            referencedColumns: ["id"]
    ...
    Views: {
      addon_purchases_with_remaining: {
        Row: {
          ...
          service_type: Database["public"]["Enums"]["addon_service_type"] | null
          sessions_consumed: number | null
          sessions_remaining: number | null
          sessions_total: number | null
          status: Database["public"]["Enums"]["addon_purchase_status"] | null
          total_paid_kwd: number | null
        }
        Relationships: [
          {
            foreignKeyName: "addon_purchases_addon_service_id_fkey"
    ...
    Functions: {
      ...
      assign_coach_atomic: {
        Args: {
          ...
          p_is_team_plan?: boolean
          p_requested_coach_id?: string
          p_selected_team_id?: string
          p_service_id: string
          p_session_booking_enabled?: boolean
          p_session_duration_minutes?: number
          p_user_id: string
          p_weekly_session_limit?: number
        }
        Returns: Json
      }
      ...
      get_current_week_bounds: { Args: never; Returns: Json }
      ...
      is_addon_eligible_professional: {
        Args: { p_purchase_id: string; p_staff_id: string }
        Returns: boolean
      }
    ...
    Enums: {
      ...
      food_approval_status: "approved" | "pending" | "rejected"
      food_log_unit: "g" | "kg" | "ml" | "l" | "serving"
      food_source:
        | "usda_foundation"
        | "usda_sr"
        | "usda_branded"
        ...
        | "custom"
        | "recipe"
      food_unit_kind: "mass" | "volume" | "serving"
      form_type:
