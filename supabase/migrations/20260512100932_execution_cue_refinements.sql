...
-- 6.1 Triceps Long Head — Overhead Extension (scapular plane)
UPDATE movement_patterns
SET execution_points = ARRAY[
...
WHERE muscle_group = 'elbow_extensors'
  AND subdivision  = 'elbow_extensors_triceps_long'
  AND movement     = 'Overhead Extension (scapular plane)';

-- 6.1 Triceps Long Head — Extension with Shoulder Extension (scapular aligned)
UPDATE movement_patterns
SET execution_points = ARRAY[
  'Slightly tense the back to hold the shoulder in place',
  'Extend the forearm away from the humerus — fully extending the elbow joint',
...
-- (was 'Scapular Depression'; renamed in 20260511 migration above)
UPDATE movement_patterns
SET execution_points = ARRAY[
...
-- (was 'Pulldown / Row (internal rotation emphasis)'; renamed in 20260511 migration above)
UPDATE movement_patterns
SET execution_points = ARRAY[
...
-- (was 'Thrust / Bridge'; renamed to 'Thrust' in 20260511 migration above)
UPDATE movement_patterns
SET execution_points = ARRAY[
